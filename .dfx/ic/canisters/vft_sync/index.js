...
import { idlFactory } from './vft_sync.did.js';
export { idlFactory } from './vft_sync.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.VFT_SYNC_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./vft_sync.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the vft_sync canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./vft_sync.did.js")._SERVICE>}
 */
export const vft_sync = createActor(canisterId);
