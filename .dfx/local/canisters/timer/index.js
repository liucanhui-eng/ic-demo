...
import { idlFactory } from './timer.did.js';
export { idlFactory } from './timer.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TIMER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./timer.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the timer canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./timer.did.js")._SERVICE>}
 */
export const timer = createActor(canisterId);
