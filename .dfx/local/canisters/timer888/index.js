...
import { idlFactory } from './timer888.did.js';
export { idlFactory } from './timer888.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TIMER888_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./timer888.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the timer888 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./timer888.did.js")._SERVICE>}
 */
export const timer888 = createActor(canisterId);
