...
import { idlFactory } from './timer2.did.js';
export { idlFactory } from './timer2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TIMER2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./timer2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the timer2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./timer2.did.js")._SERVICE>}
 */
export const timer2 = createActor(canisterId);
