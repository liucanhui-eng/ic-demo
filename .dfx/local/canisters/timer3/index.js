...
import { idlFactory } from './timer3.did.js';
export { idlFactory } from './timer3.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TIMER3_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./timer3.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the timer3 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./timer3.did.js")._SERVICE>}
 */
export const timer3 = createActor(canisterId);
