...
import { idlFactory } from './test_call.did.js';
export { idlFactory } from './test_call.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TEST_CALL_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./test_call.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the test_call canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./test_call.did.js")._SERVICE>}
 */
export const test_call = createActor(canisterId);
