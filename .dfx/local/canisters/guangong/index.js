...
import { idlFactory } from './guangong.did.js';
export { idlFactory } from './guangong.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.GUANGONG_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./guangong.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the guangong canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./guangong.did.js")._SERVICE>}
 */
export const guangong = createActor(canisterId);
